...
![Cuban Missile Crisis (Part 1)](Figure1_Cuban_Missile_Crisis3a.png)
{{< pagebreak >}}

![Cuban Missile Crisis (Part 2)](Figure1_Cuban_Missile_Crisis3b.png)
...
```{r, eval=T, fig.width=12, fig.height=12, output=T}
p3
```

...
kable_output <- table1 %>% kable( caption = "Table 1: Comparison of ICBe to ICBeLLM Workflows", "html", align = c("l", "l", "l", "l", "l")) %>%
  ...
  kableExtra::as_image(width = 8)


library(huxtable) ; #install.packages('huxtable')

# Assuming table1 is a dataframe
car_hux <- table1 %>% as_huxtable( add_colnames = TRUE) %>% #, add_rownames = "Model"
           set_font_size( 9) %>% 
           as_flextable()
...
![Cuban Missile Crisis](/media/skynet3/8tb_a/rwd_github_private/ICBeLLM/docs/Figure1_Cuban_Missile_Crisis3.png)
